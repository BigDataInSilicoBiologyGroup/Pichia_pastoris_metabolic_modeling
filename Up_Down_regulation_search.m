% function [Table_positive_contra_proportional, Table_negative_contra_proportional,Table_negative_directly_proportional,Table_positive_directly_proportional] = FSEOF_3(filename_model)
...
filename = 'Optimisation_result_3.xlsx';
